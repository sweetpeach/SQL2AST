...
def rule_vs_node_stat():
    line_num = 0
    parse_trees = []
    code_file = '/Users/shayati/Documents/summer_2018/sql_to_ast/hearthstone/all_hs.out' # '/Users/yinpengcheng/Research/SemanticParsing/CodeGeneration/en-django/all.code'
