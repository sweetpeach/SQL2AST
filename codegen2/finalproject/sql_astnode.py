...
if __name__ == '__main__':
    ...
    import ast
    t1 = SQL_ASTNode('root', children=[
        SQL_ASTNode(str, None, value="SELECT")
    ])
    '''
    t2 = SQL_ASTNode('root', children=[
        SQL_ASTNode(str, 'a1_label', children=[SQL_ASTNode(int, children=[SQL_ASTNode('a21', value=123)]),
                                           SQL_ASTNode(ast.NodeTransformer, children=[SQL_ASTNode('a21', value='hahaha')])]
                ),
        SQL_ASTNode('a2', children=[SQL_ASTNode('a21', value='asdf')])
    ])
    '''
    #print "check here: " + str(t1 == t2)
